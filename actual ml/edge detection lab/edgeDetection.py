...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 11 11:41:30 2023
...
res2 = signal.convolve2d(train_images[image_index], filter)
axarr[1,1].set_title('Vertical D->B')
axarr[1,1].imshow(res2, cmap='Greys')
...
res = signal.convolve2d(train_images[image_index], filter)
axarr[2,0].set_title('Horizontal B->D')
